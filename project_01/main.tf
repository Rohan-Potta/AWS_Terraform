resource "aws_s3_bucket" "s3_bucket" {
  bucket = "static-website-bucket-terrraform"
}
...
resource "aws_cloudfront_origin_access_control" "origin_access_control" {
  ...
  description                       = "This is for the static website with cloudfront distribution for the origin access control"
